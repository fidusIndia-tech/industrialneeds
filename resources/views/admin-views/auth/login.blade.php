...
<head>
    ...
    <style>
        ...
        .login-bg-img{
            ...
            /*background-image: url(https://img.freepik.com/free-photo/shopping-bag-cart_23-2148879372.jpg?w=900&t=st=1660891168~exp=1660891768~hmac=b712f87618879b61b05d7f291a02820432b0b690bdf5dbcc5c8712c2bee6b0c9);*/
...
<!-- ========== MAIN CONTENT ========== -->
<main id="content" role="main" class="main login-bg-img">
    ...
    <div class="container py-5 py-sm-7">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <!-- Card -->
                <div class="card card-lg main-admin-login">
                    <div class="card-body">
                        <!-- Form -->
