                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <input type="text"placeholder="5 to 6 days" name="country[{{$country->id}}][duration]" class="form-control">
                                    </div>
                                    <div class="col-md-4 mb-2">
                                        <input type="number" min="0" value="0" step="1" placeholder="{{ \App\CPU\translate('shipping_cost') }}" name="country[{{$country->id}}][cost]" class="form-control">
                                    </div>
                                    @endforeach
                                </div>
                            </div>
