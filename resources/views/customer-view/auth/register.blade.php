                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation_" action="{{route('customer.auth.sign-up')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="reg-Country">{{\App\CPU\translate('country')}}
                                            <small class="text-primary">( * {{\App\CPU\translate('Our Shipment Provide in these Countries')}})</small></label>
                                        <select class="form-control select2" name="country" id="reg-Country">
                                            <option value="">Select Country</option>
                                            @foreach ($countries as $country)
                                            <option value="{{$country->id}}">{{$country->name}}</option>
                                            @endforeach
                                        </select>
                                            {{-- <input class="form-control" type="number"  value="{{old('Country')}}"  name="Country"
                                               style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                               required> --}}
                                        {{-- <div class="invalid-feedback">{{\App\CPU\translate('Please enter your Country number')}}!</div> --}}
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
