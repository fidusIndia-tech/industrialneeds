<div id="headerMain" class="d-none">
    <header id="header" style="background-color:#f92740"
        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-left">
                ...
                <button type="button" class="js-navbar-vertical-aside-toggle-invoker close mr-3">
                    <i class="tio-menu-left-right navbar-vertical-aside-toggle-short-align" data-toggle="tooltip"
                       data-placement="right" title="Collapse"></i>
                    <i class="tio-menu-left navbar-vertical-aside-toggle-full-align"
                        ...
                        <div
                            ...
                            <div class="input-group">
                                <diV class="card" id="search-card"
                                    ...
                                    <div class="card-body" id="search-result-box" style="overflow:scroll; height:400px;overflow-x: hidden">
                                    </div>
                                </diV>
                            </div>
                        </div>
