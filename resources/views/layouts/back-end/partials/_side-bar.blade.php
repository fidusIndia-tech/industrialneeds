                ...
                <div class="navbar-vertical-footer-offset pb-0">
                    ...
                    <div class="navbar-vertical-content mt-2">
                        ...
                        @endif
                            ...
                            <li class="nav-item">
                                <small
                                    class="nav-subtitle">{{\App\CPU\translate('country')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/country/*') || Request::is('admin/country')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                    <i class="tio-shopping nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('country')}}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/country/*') || Request::is('admin/country') ?'block':'none'}}">
                                    <li class="nav-item {{Request::is('admin/country/create')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.country.create')}}"
                                        title="{{\App\CPU\translate('add_new')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{\App\CPU\translate('add')}} {{\App\CPU\translate('new')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/country')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.country.index')}}" title="{{\App\CPU\translate('country_list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('country')}} {{\App\CPU\translate('list')}}
                                            {{-- <span class="badge badge-info badge-pill ml-1">
                                                {{\App\Model\Order::where(['seller_is'=>'admin'])->where('order_type','POS')->where(['order_status'=>'delivered'])->count()}}
                                            </span> --}}
                                        </span>
                              ...
                              <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/category*') ||Request::is('admin/sub*')) ?'active':''}}">
                                ...
                                <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/product/list/in_house') || Request::is('admin/product/bulk-import') || Request::is('admin/product/price-update*') || Request::is('admin/product/image-pipeline*'))?'active':''}}">
                                    ...
                                    href="javascript:">
                                        ...
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            <span class="text-truncate">{{\App\CPU\translate('Add Products')}}</span>
                                        </span>
                                    </a>
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li class="nav-item {{Request::is('admin/product/image-pipeline*')?'active':''}}">
                                            <a class="nav-link " href="{{route('admin.product.image-pipeline')}}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{\App\CPU\translate('Image Pipeline')}}</span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li class="nav-item {{Request::is('admin/report/inhoue-product-sale')?'active':''}}">
                                            <a class="nav-link" href="{{route('admin.report.inhoue-product-sale')}}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">
                                                    {{\App\CPU\translate('Naira')}} {{\App\CPU\translate('sales')}}
                                                </span>
                                            </a>
                                        </li>
                        ...
                        <!--reporting and analysis ends here-->
                            ...
                            <!-- @if(\App\CPU\Helpers::module_permission_check('delivery_man_management'))
                                ...
                                <li class="navbar-vertical-aside-has-menu {{Request::is('admin/delivery-man*')?'active':''}}">
                                    ...
                                    <li class="nav-item {{Request::is('admin/feedbacklist')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.feedbacklist')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('feedback_list')}}</span>
                                        </a>
                                    </li>
                                </li>
                            @endif
