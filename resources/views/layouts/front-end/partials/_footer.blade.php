			  ...
			  <div class="col-md-3">
                ...
                <br><br><br><br>
					 <div class="row pl-2 d-flex align-items-center mobile-view-center-align {{Session::get('direction') === "rtl" ? ' flex-row-reverse' : ''}}">
									<div>
										<span class="mb-3 font-weight-bold footer-heder">{{ \App\CPU\translate('address')}}</span>
									</div>
								<!--	<div class="{{Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'}}">
										<hr class="address_under_line" style="border:1px solid #E0E0E0; width:210px"/>
									</div>-->
                            </div>
							<div class="row pl-2">
							...
							<br>
							<div class="changes mb-2">
								<div style="color:" class="">
									<a class="widget-list-link" href="tel: {{$web_config['phone']->value}}">
										<span style="display: flex; align-items: baseline;"><i class="fa fa-phone m-2"></i>{{\App\CPU\Helpers::get_business_settings('company_phone')}} </span>
									</a>								
								</div>
								
								<div style=""class="">
									<a class="widget-list-link" href="email:">
										<span style="display: flex; align-items: baseline;"><i class="fa fa-envelope m-2"></i> {{\App\CPU\Helpers::get_business_settings('company_email')
										}} </span>
									</a>
								</div>
							</div>
                ...
                <div class="col-md-9" >
                    <div class="row">
                        ...
                        <div class="col-md-3 footer-padding-bottom" >
                            <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">{{\App\CPU\translate('Quick Links')}}</h6>
    ...
    <div style="background: {{$web_config['primary_color']}}10;">
        <div class="container">
            <div class="row text-center text-md-left">
                <p style="font-size:12px;">Design and maintain by <a href="javascript:void(0);" style="color: #fea569 !important;">aricxes.com</a></p>
            </div>
        </div>
    </div>
    <!-- Footer Links -->
