...
@section('title',\App\CPU\translate('customer-feedback'))
...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="https://ppcdigital.in/fmcg/assets/css/owl.carousel.min.css">
...
@section('content')
    <div class="container rtl">
        <div class="row">
            <div class="col-md-12 sidebar_heading text-center mb-2">
                <h1 class="h3  mb-0 folot-left headerTitle">Feedback</h1>
            </div>
        </div>
    </div>
    ...
    <div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row no-gutters">
            ...
            <div class="col-lg-12 for-send-message px-4 px-xl-5  box-shadow-sm">
                <h2 class="h4 mb-4 text-center"
                    style="color: #030303; font-weight:600;">{{\App\CPU\translate('send_us_a_message')}}</h2>
                    <form action="{{route('feedback-store')}}" method="POST" id="getResponse">
                        @csrf
                        <div class="row">
                          <div class="col-sm-4">
                              <div class="form-group">
                                <label >{{\App\CPU\translate('full_name')}}</label>
                                <input class="form-control name" name="full_name" type="text" 
                          ...
                          <div class="col-sm-4">
                              <div class="form-group">
                                <label for="name">{{\App\CPU\translate('company_name')}}</label>
                                <input class="form-control email" name="company_name" type="text" 
                            ...
                            <div class="col-sm-4">
                              <div class="form-group">
                                ...
                                <input class="form-control mobile_number"  type="text" name="phone_no"
                                  value="{{ old('phone_no') }}"  placeholder="{{\App\CPU\translate('Contact Number')}}" required>

                              </div>
                            </div>
                             <div class="col-md-12">
                            <div class="form-group">
                              <label for="cf-message">{{\App\CPU\translate('feedback')}}</label>
                              <textarea class="form-control message" name="feedback"   rows="6" required>{{ old('feedback') }}</textarea>
                            </div>
                          </div>
                        </div>
                        {{-- recaptcha --}}
