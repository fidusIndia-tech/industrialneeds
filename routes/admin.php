...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'refund-section', 'as' => 'refund-section.' ,'middleware'=>['module:business_section']], function () {
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
            ...
            Route::group(['prefix' => 'order-settings', 'as' => 'order-settings.','middleware'=>['module:business_settings']], function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::post('update-status-history', 'OrderController@update_status_history')->name('update-status-history');
      	...
      	Route::get('feedbacklist','OrderController@feedbacklist')->name('feedbacklist');
        Route::get('feedbacksapprovel/{id}','OrderController@feedbacksapprovel')->name('feedbacksapprovel');
		 Route::get('feedbackreject/{id}','OrderController@feedbackreject')->name('feedbackreject'); 
        //pos management
    ...
    Route::get('country/delete/{id}',[App\Http\Controllers\Admin\CountryController::class,'destroy'])->name('country.delete');
