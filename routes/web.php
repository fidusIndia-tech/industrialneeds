...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('cancelation', 'WebController@cancelation')->name('cancelation');
    ...
    Route::get('shipping-policy', 'WebController@shipping_policy')->name('shipping-policy');
    ...
    Route::get('about-us', 'WebController@about_us')->name('about-us');
  	Route::get('customer-feedback', 'WebController@feedback')->name('customer-feedback');
    Route::post('feedback-store', 'WebController@feedback_store')->name('feedback-store');
